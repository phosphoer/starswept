(function waveInit(api)
{
  ...
  api.play = function(name, volume, onEnded)
  {
    if (!bufferMap[name])
      throw "Wave: Sound with name " + name + " hasn't been loaded";

    playSound(name, volume, onEnded);
  };
  ...
  var playSoundWebAudio = function(name, volume, onEnded)
  {
  ...
  var playSoundHTML5 = function(name, volume, onEnded)
  {
